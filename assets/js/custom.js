...
jQuery(function($) {
	...
	jQuery(window).load(function() { // makes sure the whole site is loaded
		...
		$.getScript("https://maps.googleapis.com/maps/api/js?key=AIzaSyBLSDySD2_kQhU8fT8ChvEUPzSozuMt_c4&callback=initMap");
	});
...
function initMap() {
 ...
 /*vijay nagar*/
	...
	var infowindow = new google.maps.InfoWindow({
		content: '<h4>Homeoheal (Sukhdev Nagar, Airport Road)</h4> <a target="_blank" href="https://maps.google.com?saddr=Current+Location&daddr=22.726275,75.824482">Get Directions</a>'
	});

	infowindow.open(map, marker);

	var infowindow2 = new google.maps.InfoWindow({
		content: '<h4>Homeoheal (Kadabin, Near Bada Ganpati)</h4> <a target="_blank" href="https://maps.google.com?saddr=Current+Location&daddr=22.721037,75.842865">Get Directions</a>'
	});
